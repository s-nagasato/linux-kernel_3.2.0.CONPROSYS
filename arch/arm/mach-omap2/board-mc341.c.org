...
static struct omap_board_mux board_mux[] __initdata = {
	...
	AM33XX_MUX(XDMA_EVENT_INTR0, OMAP_MUX_MODE7 | AM33XX_PIN_INPUT_PULLUP),
...
struct mc341_eeprom_config {
	...
	u8	display;	//  0x00FCMOS OUT DISABLEALVDS OUT DISABLE
	u8	mac0[6];	// mac address
	u8	mac1[6];	// mac address
	u8	ssp;		// Select Spread Spectrum Clocking 0x00FNone
	u8	debport;	// 
...
//	{"gpmc_ad7.gpio1_7", OMAP_MUX_MODE7 | AM33XX_PIN_INPUT}, // RS(Half/full) 2015.01.16
//	{"gpmc_ad7.mmc1_dat7", OMAP_MUX_MODE1 | AM33XX_PIN_INPUT}, // RS(Half/full) 2015.01.16
...
//	{"uart1_ctsn.uart1_ctsn", OMAP_MUX_MODE6 | AM33XX_PIN_OUTPUT},	/* UART3_CTSn 3G-CN */
	{"lcd_data11.uart3_rtsn", OMAP_MUX_MODE6 | AM33XX_PIN_INPUT_PULLUP},/* UART3_RTSn 3G-CN */
	{"lcd_data10.uart3_ctsn", OMAP_MUX_MODE6 | AM33XX_PIN_OUTPUT},	/* UART3_CTSn 3G-CN */
	{NULL, 0},
};
/* EVM - Starter Kit */
// koko
